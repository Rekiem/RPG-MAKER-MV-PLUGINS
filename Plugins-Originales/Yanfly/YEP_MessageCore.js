...
//=============================================================================
 /*:
 * @plugindesc v1.03 Adiciona mais características para a Janela de Mensagem
 ...
 *
 * @param Default Rows
 * @desc Essa é a quantidade padrão de linhas que a caixa de mensagem irá ter.
 * Padrão: 4
 * @default 4
 *
 * @param Default Width
 * @desc Essa é a largura padrão para a caixa de mensagem em pixels.
 * Padrão: Graphics.boxWidth
 * @default Graphics.boxWidth
 *
 * @param Face Indent
 * @desc Se usando uma face gráfica, isso é o quanto o texto será recuado.
 * Padrão: Window_Base._faceWidth + 24
 * @default Window_Base._faceWidth + 24
 *
 * @param Fast Forward
 * @desc Usando isso irá habilitar um botão de avanço rápido para avançar
 * adiante rapidamente. Se não quiser usar, use "false".
 * @default Input.isPressed('pagedown')
 *
 * @param Word Wrapping
 * @desc Use isso para habilitar ou desabilitar o cobrimento de palavras por
 * padrão. DESLIGADO - false     LIGADO - true
 * @default false
 *
 * @param Description Wrap
 * @desc Use isso para habilitar ou desabilitar o cobrimento de palavras para
 * descrições. DESLIGADO - false     LIGADO - true
 * @default false
 *
 * @param ---Font---
 * @default
 *
 * @param Font Name
 * @desc Essa é a fonte padrão usada para a Janela de Mensagem.
 * Padrão: GameFont
 * @default GameFont
 *
 * @param Font Size
 * @desc Esse é o tamanho da fonte padrão usada para a Janela de Mensagem.
 * Padrão: 28
 * @default 28
 *
 * @param Font Size Change
 * @desc Todas as vezes que \{ e \} forem usados, eles ajustam por esse valor.
 * Padrão: 12
 * @default 12
 *
 * @param Font Changed Max
 * @desc Esse é o tamanho máximo alcançado por \{.
 * Padrão: 96
 * @default 96
 *
 * @param Font Changed Min
 * @desc Esse é o tamanho mínimo alcançado por \{.
 * Padrão: 12
 * @default 12
 *
 * @param ---Name Box---
 ...
 * @desc Esse é o buffer para a localização x da Caixa de Nome.
 * @default -28
 *
 * @param Name Box Buffer Y
 * @desc Esse é o buffer para a localização y da Caixa de Nome.
 * @default 0
 *
 * @param Name Box Padding
 * @desc Esse é o valor para o preenchimento da Caixa de Nome.
 * @default this.standardPadding() * 4
 *
 * @param Name Box Color
 * @desc Essa é a cor do texto usado para a Caixa de Nome.
 * @default 0
 *
 ...
 * @desc Esse texto é sempre adicionado toda vez que a Caixa de Nome é usada.
 * Isso pode ser usado para estabelecer automaticamente as cores.
 * @default \c[6]
 *
 * @help
 * ============================================================================
 ...
 * a escrever os ícones e/ou os nomes dos itens, armas, armaduras, e* de um
 * jeito mais rápido. Esse script também dá ao desenvolvedor a abilidade de
 ...
 * que o jogo os substituam com os seguintes:
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *
 ...
 *   \<                Cancela todo o efeito que mostra o texto de uma vez.
 *   \^                Não espera entrada de dados depois de mostrar o texto.
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *
 *  Esperar:    Efeito:
 *    \w[x]     - Espera x frames (60 frames = 1 segundo). Janela de Mensagem
 *                apenas.
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *
 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *
 * E esses são os códigos de textos adicionados nesse script. Tenha em
 * mente que alguns desses códigos de textos só funcionam para a Janela
 ...
 *                            Mostrar o Texto, isso continuará mostrando
 ...
 *                            400 pixels. Isso irá cortar qualquer palavra
