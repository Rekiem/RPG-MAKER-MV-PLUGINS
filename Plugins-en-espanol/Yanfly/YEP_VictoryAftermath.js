...
//=============================================================================
 /*:
 * @plugindesc Muestra una ventana informativa al terminar una batalla
 * en lugar de un cuadro indicando lo que gano la party.
 ...
 *
 * @param Victory Order
 * @desc Este es el orden que la secuencia de victoria tendrá.
 * Separe cada parte con un espacio.
 ...
 *
 * @param Victory BGM
 * @desc Este será el BGM usado cuando la batalla termine.
 * Asignado : Ship3
 * @default Ship3
 *
 * @param BGM Volume
 * @desc Este será el volumen del BGM que será reproducido.
 * @default 90
 *
 * @param BGM Pitch
 * @desc Este será el pitch del BGM que será reproducido.
 * @default 100
 *
 * @param BGM Pan
 * @desc Este será el pan del BGM que será reproducido.
 * @default 0
 *
 * @param ---Battle Results(Resultados de la Batalla)---
 * @default
 *
 * @param Cheer Wait
 * @desc Cantidad de frames en que los personajes se mostraran
 * animados antes que la ventana de victoria aparezca.
 * @default 90
 *
 * @param Battle Results Text
 * @desc Texto usado para el texto de resultados de la batalla.
 * Por defecto : Battle Results
 * @default Battle Results
 *
 * @param Battle Drops Text
 * @desc Texto usado para los drops ganados en batalla.
 * Por defecto : Battle Spoils
 * @default Battle Spoils
 *
 * @param ---EXP Window(Ventana de Experiencia)---
 * @default
 *
 * @param Level Up Text
 * @desc Este es el texto usado cuando se sube de nivel.
 * Por defecto : LEVEL UP!
 * @default LEVEL UP!
 *
 * @param Max Level Text
 * @desc Texto usado cuando el personaje esta en nivel máximo.
 * Por defecto : MAX LEVEL
 * @default MAX LEVEL
 *
 * @param Show Skills Learned
 * @desc Mostrar habilidades aprendidas en el nivel superior?
 * NO - false     YES - true
 * @default true
 *
 * @param Gained EXP Text
 * @desc Texto que etiqueta cuanto de EXP fue ganado en batalla.
 * Por defecto : Gained EXP
 * @default Gained EXP
 *
 * @param Gained EXP Format
 * @desc Texto que muestra cuanto de EXP fue ganado en batalla.
 * Por defecto : +%1
 * @default +%1
 *
 * @param EXP Gauge Color 1
 * @desc El color de la skin utilizada en el EXP Gauge Color 1  
 * mostrada en la ventana de resultados de victoria.
 * @default 30
 *
 * @param EXP Gauge Color 2
 * @desc El color de la skin utilizada en el EXP Gauge Color 2 
 * mostrada en la ventana de resultados de victoria.
 * @default 31
 *
 * @param Level Gauge Color 1
 * @desc El color de la skin utilizada en el EXP Gauge Color 1  
 * si el personaje sube de nivel.
 * @default 14
 *
 ...
 *
 * @param Gauge Ticks
 * @desc Cantidad de ticks que van a ocurrir antes que el 
 * indicador de EXP este lleno. Cada tick es de 4 frames.
 * @default 15
 *
 * @param Tick SE
 * @desc Esto será el sonido usado en cuanto el indicador de EXP
 * se llena.  Por defecto : Absorb2
 * @default Absorb2
 *
 * @param Tick Volume
 * @desc Este será el volumen del BGM que va a reproducir.
 * @default 90
 *
 * @param Tick Pitch
 * @desc Este será el pitch del BGM que va a reproducir.
 * @default 150
 *
 * @param Tick Pan
 * @desc Este será el pan de BGM que va a reproducir.
 * @default 0
 *
 * @help
 * ============================================================================
 ...
 * ============================================================================
 *
 * Este plugin cambia los mensajes de victoria del sistema de batalla por
 * defecto en favor de mostrar más ventanas informativas. Ajuste los parámetros
 * para cambiar la configuración para que este encaje en su juego.
 *
 * ============================================================================
 * Victory Aftermath - Resultado de Victoria
 * ============================================================================
 *
 * En los parámetros, hay un parámetro 'Victory Order'. Este parámetro permite
 * elegir el orden de los pasos del Resultado de Victoria.
 *
 * El orden predeterminado es el siguiente:
 *           exp         Muestra la ventana de EXP.
 *           custom      Muestra cualquier plugin de extensión personalizado.
 *           drops       Muestra la ventana de drops.
 *
 * Si usted cambia el orden de estos pasos, agregar pasos, o eliminar pasos 
 * del plugin 'Victory Order', el Resultado de Victoria va a corresponderá a
 * cualquier cambio que usted haga.
 *
 * ============================================================================
 * Plugin Commands -  Comandos de Plugin
 * ============================================================================
 *
 * Si desea modificar un poco la secuencia de Resultado de Victoria, usted
 * puede usar los siguientes comandos de plugin.
 *
 * Comandos de Plugin:
 *   DisableVictoryAftermath   - Desactiva la secuencia del Resultado de
 *                               Victoria y evita su música, también.
 *   EnableVictoryAftermath    - Habilita la secuencia de Resultado de
 *                               Victoria si fue previamente desactivado.
 *   DisableVictoryMusic       - Desactiva la música del Resultado de Victoria
 *                               para continuar tocando la que estaba tocando.
 *   EnableVictoryMusic        - Habilita la música del Resultado de Victoria
 *                               si fue previamente desactivado.
 *
 * ============================================================================
 * Changelog
 * ============================================================================
